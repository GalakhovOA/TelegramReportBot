...
# Список Telegram ID для РМ/МН (региональный менеджер и менеджер направления)
RM_MN_IDS = [
...
QUESTIONS = [
    ...
    {"key": "ckp_realized", "question": "Реализованные ЦКП:"},
]
